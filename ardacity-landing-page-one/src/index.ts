...
// This is just a placeholder to generate the .d.ts file
// The actual implementation is in the templates folder
const LandingPageOne = (_props: LandingPageOneProps): ReactNode => null;
